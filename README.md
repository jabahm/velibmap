...
![Capture d'écran de VélibMap](docs/thumbnail.png)

## Fonctionnalités

- **Carte temps réel** des ~1 500 stations, refresh auto toutes les 60 s
- **Clustering** dynamique + marker individuel **coloré selon le besoin** (vert ≥ 3 dispo, ambre 1-2, gris 0)
...
- [Tailwind CSS v4](https://tailwindcss.com/) + [shadcn/ui](https://ui.shadcn.com/) tokens
...
Optionnel — variables d'environnement Vite :
